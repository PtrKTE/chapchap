...
return [
    ...
    */
    ...
    'options' => [
         ...
         */
        // Subsetting désactivé = moins de traitement à la génération
         ...
         * @var int
         */
        // 72 DPI suffit pour un ticket de caisse 80mm — plus rapide à rendre
        'dpi' => 72,
         ...
         * @var bool
         */
        // Désactivé : inutile pour nos reçus, évite un parsing superflu
