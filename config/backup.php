...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * On ne backup que la BDD — le code source est dans Git.
                 * On inclut quand même le .env et les fichiers uploadés.
                 */
                'include' => [
                    base_path('.env'),
                    storage_path('app'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_MAIL_TO', 'admin@chapchap.ci'),
